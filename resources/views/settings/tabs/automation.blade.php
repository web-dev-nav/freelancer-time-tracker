...
<div class="settings-section automation-shell">
    ...
    <div class="automation-body">
        ...
        <div class="automation-compact-shell">
            <div class="automation-card">
                <div class="automation-card-head" style="margin-bottom:6px;">
                    <div>
                        <div class="automation-client-name">Custom Email Scheduler</div>
                        <div class="automation-client-email">Schedule one-off or recurring emails to multiple recipients.</div>
                    </div>
                    <div class="automation-card-status">Runs every 5 min</div>
                </div>

                <details class="automation-details" open>
                    <summary>New Scheduled Email</summary>
            ...
            <div class="automation-card">
                <div class="automation-card-head" style="margin-bottom:8px;">
                    <div>
